...
const GeneralTimeline = (props) => {
    const { generalData, userData } = props
                ...
                if (idx < 4) {
                    ...
                    const tempData = {
                        ...
                        customContent: (
                            ...
                            <Avatar  img={imagePath} type='button' tag={Link} to={`${ROUTE_EDUCATION}/general/detail/${data.id}`}/>
                            <div className='ms-50'>
    ...
    return (
        <div>
            {generalTableData && 
                <Timeline className='ms-50 mb-0 general' data={generalTableData} />
            }
        </div>
    )
