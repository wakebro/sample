...
import EnergyCustomTable from "../table/EnergyCustomTable"


const SolidDay = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            with: '100px',
            cell: row => row.middle_price.toLocaleString('ko-KR')
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
                    <div style={{height:'50%'}} className="d-flex align-items-center justify-content-center">일 사용금액</div>
                    <div style={{ borderTop: '2px solid #B9B9C3', height:'50%', borderRight: '1px solid #B9B9C3'}} className="d-flex align-items-center justify-content-center">저압</div>
                </div>
            ),
            with: '100px',
            cell: row => row.low_price.toLocaleString('ko-KR')
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
            ...
            with: '100px',
            cell: row => row.cook_price.toLocaleString('ko-KR')
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
