...
const SoildCompare = (props) => {
    ...
    const columns = [
        ...
        {
            name: '작년대비 증감률',
            cell: row => row.change_rate_boiler.toLocaleString('ko-KR', {minimumFractionDigits: 2, maximumFractionDigits: 2 })
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
        ...
        {
            name: '작년대비 증감률',
            cell: row => row.change_rate_gas_used.toLocaleString('ko-KR', {minimumFractionDigits: 2, maximumFractionDigits: 2 })
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
        ...
        {
            name: '작년대비 증감률',
            cell: row => row.change_rate_gas.toLocaleString('ko-KR', {minimumFractionDigits: 2, maximumFractionDigits: 2 })
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
                    <div style={{height:'50%', justifyContent:'end'}} className="d-flex align-items-center">외기</div>
                    <div style={{ borderTop: '2px solid #B9B9C3', height:'50%', borderRight: '1px solid #B9B9C3'}} className="d-flex align-items-center justify-content-center">최저</div>
                </div>
            ),
            with: '20px',
            cell: row => <Fragment><div style={{color:'blue'}}>{row.low_temp}</div></Fragment>
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
                    <div style={{height:'50%'}} className="d-flex align-items-center">온도</div>
                    <div style={{ borderTop: '2px solid #B9B9C3', height:'50%', borderRight: '1px solid #B9B9C3'}} className="d-flex align-items-center justify-content-center">최고</div>
                </div>
            ),
            with: '20px',
            cell: row => <Fragment><div style={{color:'red'}}>{row.high_temp}</div></Fragment>
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
                    <div style={{height:'50%', justifyContent:'end'}} className="d-flex align-items-center">수</div>
                    <div style={{ borderTop: '2px solid #B9B9C3', height:'50%', borderRight: '1px solid #B9B9C3'}} className="d-flex align-items-center justify-content-center">검침량</div>
                </div>
            ),
            with: '20px',
            cell: row => row.water_supply.toLocaleString('ko-KR')
        },
        {
            name: (
                <div style={{width: '100%', height:'100%'}}>
                    <div style={{height:'50%'}} className="d-flex align-items-center">도</div>
                    <div style={{ borderTop: '2px solid #B9B9C3', height:'50%', borderRight: '1px solid #B9B9C3'}} className="d-flex align-items-center justify-content-center">사용량</div>
                </div>
            ),
            with: '20px',
            cell: row => row.water_used.toLocaleString('ko-KR')
        }
    ]
