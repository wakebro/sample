...
const UtilitiesIDR = () => {
    ...
    const getInit = () => {
        ...
        getTableData(API_ENERGY_UTILITIES_IDR, param, setDataTable)
    }
        ...
        <Fragment>
			<Row>
                <div className='d-flex justify-content-start'>
                    <Breadcrumbs 
                        breadCrumbTitle='수광비실적증감률' 
                        breadCrumbParent='에너지관리' 
                        breadCrumbParent2='수광비관리'
                        breadCrumbActive='수광비실적증감률'
                    />
                </div>
			</Row>
            <Card>
                ...
                <CardBody className='mt-0'>
                    ...
                    <HotTable 
                        ...
                        nestedHeaders={
                            [[{label:'구분', colspan: 3}, '년도', '1월', '2월', '3월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월', '계']]
                        }
