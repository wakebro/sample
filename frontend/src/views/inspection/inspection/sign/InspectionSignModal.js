...
import InspectionSignTable from './InspectionSignTable'
import { primaryColor } from '../../../../utility/Utils'

const InspectionSignModal = (props) => {
    useAxiosIntercepter()
    const {
        isOpen, setIsOpen, userSign, setUserSign, 
        signType, setSignType, inputData, navigate,
...
export default InspectionSignModal