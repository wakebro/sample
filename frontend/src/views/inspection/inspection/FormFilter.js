...
const FormFilter = (props) => {
	...
	const {searchValue, setSearchValue, statusList, statusSelect, setStatusSelect, classSelect, setClassSelect, classList, setClassList, handleSearch} = props
	const getInit = () => {
		const param = {
			...
			<Row>
				<Col md={10} >
					<Row>
						...
						<Col className='mb-1'md={3} xs={12}>
							<Row>
								<Col md={3}  xs={3}className="d-flex align-items-center justify-content-center" style={{ padding: 0 }} htmlFor='jobSelect'>상태</Col>
								<Col md={9}  xs={9}>
									<Select
										classNamePrefix={'select'}
										className="react-select"
