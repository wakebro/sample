...
const StockLogTotalTable = (props) => {
	const {columns, tableData, setTabelData, setTableSelect, selectType, detailAPI, state, customFooter} = props
...
export default StockLogTotalTable