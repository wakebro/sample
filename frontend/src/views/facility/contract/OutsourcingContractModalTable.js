...
const OutsourcingContractModalTable = (props) => {
	const {columns, tableData, setTabelData, setTableSelect, selectType, setClick} = props
...
export default OutsourcingContractModalTable