...
const RoomCustomDataTable = (props) => {
	const {columns, tableData, setTabelData = null, tableSelect, setTableSelect, selectType, detailAPI, state, rowCnt = 10, styles = customStyles, footer = undefined} = props
...
export default RoomCustomDataTable