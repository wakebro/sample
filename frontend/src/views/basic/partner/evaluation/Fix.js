...
import {
    CalculateTotalScore, setStringDate,
    axiosPostPutNavi
    // getTableData
    //  makeSelectList 
    } from "../../../../utility/Utils"
...
const Partner_Management_Evaluation_Register = () => {
    ...
    const onSubmit = (e) => {
        ...
        axiosPostPutNavi('modify', '협력업체', API_BASICINFO_PARTNER_EVALUATION_DETAIL, formData, navigator, ROUTE_BASICINFO_PARTNER_MANAGEMENT_EVALUATION)
    } //  submit end
    ...
    useEffect(() => {
        ...
        .then(
            res => {
                ...
                setEmployeeLevel(res.data.evaluator_employee_class)
                setUserName(res.data.evaluator)
                setDate(res.data.evaluate_duration)
                setWritingDate(res.data.writing_date)
